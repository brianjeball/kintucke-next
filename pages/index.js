  ...
  return (
    <Popover className="absolute left-20">
      ...
      <Popover.Panel className="absolute z-10">
        <Image src="/assets/images/kintucke-cover.png" alt='catch22 cover art' width={300} height={300} />
...
const Home = () => {
  ...
  return (
    <Layout pageTitle="home">
      ...
      {/* <CoverArtInteractive /> */}
      <Image src="/assets/images/kintucke-cover.png" alt='catch22 cover art' width={600} height={600} />
      <Footer />
    </Layout>
  )
}
